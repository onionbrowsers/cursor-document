...
| 行距过密 | **Step F** |
| 闹钟 / 四宫格 / 头像风（应对图2圆钟/公文包/三节点） | **Step G**（误用 289 path，已改 796） |

---

## Step G — 796 专用 path 替换 289 图标（2026-06-03 补）

| 项 | 内容 |
|----|------|
| **问题** | 图1：289 闹钟、四宫格、通道头像风；图2：圆钟、公文包、三节点 |
| **DSL 节点** | 定时 `732:81561`+`732:81560`；技能 `732:81571`；市场 `732:81568` |
| **改动** | `SIDEBAR_NAV_796_*` + 更新 `cronTaskIcon` / `inspirationIcon` / `agentMarketNavIcon` |
| **状态** | `done` |
